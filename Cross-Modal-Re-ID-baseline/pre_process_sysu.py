...
with open(os.path.join(data_path, 'train_rgb_path.pkl'), 'wb') as file:
    pkl.dump(files_rgb, file)
...
with open(os.path.join(data_path, 'train_ir_path.pkl'), 'wb') as file:
    pkl.dump(files_ir, file)
