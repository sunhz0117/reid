...
class SYSUData(data.Dataset):
    def __init__(self, data_dir, transform=None, colorIndex = None, thermalIndex = None):
        ...
        with open(os.path.join(data_dir, "train_rgb_path.pkl"), "rb")as file:
            self.train_color_path = pkl.load(file)
        ...
        with open(os.path.join(data_dir, "train_ir_path.pkl"), "rb")as file:
            self.train_ir_path = pkl.load(file)
        ...
        # rgb attribute
        self.attr_dict = {}
        with open("sysu_attribute.txt", "r")as file:
    ...
    def __getitem__(self, index):
        ...
        attr1 = torch.LongTensor(self.attr_dict[self.train_color_path[self.cIndex[index]]])
        attr2 = torch.LongTensor([-1 for _ in range(12)])

        return img1, img2, target1, target2, attr1, attr2
...
class RegDBData(data.Dataset):
    def __init__(self, data_dir, trial, transform=None, colorIndex = None, thermalIndex = None):
        # Load training images (path) and labels
        data_dir = '/home/zzz/pytorch/ECNU_TXD/shz/data/regdb'
...
class TestData(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        img1 = self.transform(img1)
        attr1 = torch.LongTensor([-1 for _ in range(12)])

        return img1, target1, attr1
