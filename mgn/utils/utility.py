...
class checkpoint():
    ...
    def save(self, trainer, epoch, is_best=False, comment=""):
        trainer.model.save(self.dir, epoch, is_best=is_best, comment=comment)
    ...
    def plot_map_rank(self, epoch):
        ...
        labels = ['mAP','rank1','rank3','rank5','rank10','rank20']
        fig = plt.figure()
        plt.title(label)
