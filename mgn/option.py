...
parser.add_argument("--datadir", type=str, default="/home/zzz/pytorch/ECNU_TXD/shz/data/market1501", help='dataset directory')
...
parser.add_argument('--vis_attr', type=str, default='attr_show', help='attribute visualization')
