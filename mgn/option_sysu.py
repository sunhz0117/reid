...
parser = argparse.ArgumentParser(description='BIMGN')

parser.add_argument('--nThread', type=int, default=4, help='number of threads for data loading')
parser.add_argument('--cpu', action='store_true', help='use cpu only')
parser.add_argument('--nGPU', type=int, default=1, help='number of GPUs')

parser.add_argument("--datadir", type=str, default="/home/zzz/pytorch/ECNU_TXD/shz/data/sysu", help='dataset directory')
parser.add_argument('--data_train', type=str, default='SYSU', help='train dataset name')
parser.add_argument('--data_test', type=str, default='SYSU', help='test dataset name')
...
parser.add_argument('--model', default='BIMGN', help='model name')
parser.add_argument('--loss', type=str, default='1*ID+2*Triplet', help='loss function configuration')
...
parser.add_argument('--num_classes', type=int, default=395, help='')
parser.add_argument('--num_attributes', type=int, default=39, help='')
...
parser.add_argument('--decay_type', type=str, default='step_320_380', help='learning rate decay type')
...
parser.add_argument('--non_local', action='store_true', default=False, help='use non local')
...
parser.add_argument('--vis_attr', type=str, default='sysu_attr_show', help='attribute visualization')
